...
exports.updateClubMemberWithJoinPer = 'update club_member set joinper_date = ? where join_no = ? and club_no = ?'
exports.updateClubMemberWithClubOut = 'update club_member set clubout_date = ? where join_no = ? and club_no = ?'
exports.deleteClubMember = 'delete from club_member where join_no = ?'