...
exports.updateClubMemberWithJoinPer = 'update club_member set joinper_date = ? where join_no = ?'
exports.updateClubMemberWithClubOut = 'update club_member set clubout_date = ? where join_no = ?'
